...
const orderModifier = order => {
  ...
  console.log(`Olá ${newOrder.name}, o total do seu pedido de ${Object.keys(newOrder.order.pizza).join(', ')} e ${newOrder.order.drinks.coke.type} é R$${newOrder.payment.total},00`);
}
